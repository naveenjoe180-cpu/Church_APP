...
const styles = StyleSheet.create({
  ...
  calendarWeekdayRow: { flexDirection: 'row', flexWrap: 'wrap', marginBottom: 10 },
  calendarWeekdayLabel: { width: '14.2857%', paddingHorizontal: 2, color: colors.teal, fontSize: 12, fontWeight: '800', textAlign: 'center', textTransform: 'uppercase' },
  calendarWeekdayLabelCompact: { fontSize: 10 },
  calendarGrid: { flexDirection: 'row', flexWrap: 'wrap' },
  calendarDayTile: { width: '14.2857%', minHeight: 76, marginBottom: 6, backgroundColor: colors.white, borderRadius: 14, paddingHorizontal: 3, paddingVertical: 6, borderWidth: 1, borderColor: colors.softLine, justifyContent: 'space-between' },
  calendarDayTileCompact: { minHeight: 60, paddingHorizontal: 2, paddingVertical: 5, borderRadius: 12 },
